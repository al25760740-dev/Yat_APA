...
estudiante1 = Estudiante("Yatzil",19,"Ing. en Sistemas")
estudiante2 = Estudiante("Estrella",25,"Ing. en Industrial")
estudiante3 = Estudiante("Pepe",20,"Ing. en Electrónica")
...
print(f"La calificación de {estudiante1.getNombre()} es: {estudiante1.mostrarPromedio()}")
print(f"La calificación es: {estudiante2.getNombre()} es: {estudiante2.mostrarPromedio()}")
print(f"La calificacion es: {estudiante3.getNombre()} es: {estudiante3.mostrarPromedio()}")
